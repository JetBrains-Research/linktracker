...
@JvmOverloads
fun GitRepository.git(command: String, ignoreNonZeroExitCode: Boolean = false) =
    cd { git(project, command, ignoreNonZeroExitCode) }

fun GitPlatformTest.git(command: String, ignoreNonZeroExitCode: Boolean = false) =
...
fun GitRepository.checkoutNew(branchName: String, startPoint: String = "") =
...
fun GitRepository.appendAndCommit(file: String, additionalContent: String) =
