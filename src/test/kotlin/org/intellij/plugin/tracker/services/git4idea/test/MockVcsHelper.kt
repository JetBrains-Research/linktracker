...
class MockVcsHelper(project: Project) : AbstractVcsHelper(project) {
    @Volatile
    private var myCommitDialogShown: Boolean = false

    @Volatile
    private var myMergeDialogShown: Boolean = false

    @Volatile
    private var myMergeDelegate: () -> Unit = { throw IllegalStateException() }

    @Volatile
    private var myCommitDelegate: (String) -> Boolean = { throw IllegalStateException() }

    override fun runTransactionRunnable(
        vcs: AbstractVcs?,
    ...
    override fun showCommittedChangesBrowser(
        provider: CommittedChangesProvider<*, *>,
    ...
    override fun openCommittedChangesTab(
        provider: CommittedChangesProvider<*, *>,
        location: RepositoryLocation,
    ...
    override fun selectFilesToProcess(
        files: List<VirtualFile>,
        title: String,
        prompt: String?,
        singleFileTitle: String?,
        singleFilePromptTemplate: String?,
        confirmationOption: VcsShowConfirmationOption
    ): Collection<VirtualFile>? {
        throw UnsupportedOperationException()
    }

    override fun selectFilePathsToProcess(
        files: List<FilePath>,
        title: String,
        prompt: String?,
        singleFileTitle: String?,
    ...
    override fun loadAndShowCommittedChangesDetails(
        project: Project,
    ...
    override fun commitChanges(
        ...
        customResultHandler: CommitResultHandler?
    ): Boolean {
    ...
    fun registerHandler(handler: CommitHandler) {
        myCommitDelegate = { handler.commit(it) }
    }

    @Deprecated("use onMerge")
    fun registerHandler(handler: MergeHandler) {
